...
\begin{frame}{Popis experimentu}
    ...
    \end{enumerate}
        ...
        \begin{column}{0.45\textwidth}
            \visible<4->{\includegraphics[width=\textwidth]{def1.pdf}}
        \visible<5->{\includegraphics[width=\textwidth]{def2.pdf}}
        \end{column}
\end{columns}
\end{frame}
    ...
    \begin{itemize}
        \item Objeveno několik problémů
            \begin{enumerate}
                ...
                \end{itemize}
            \includegraphics[width=1.5in]{asy/mustek.drawio.pdf}}
...
\begin{frame}{Výsledky -- CoFe}
   ...
   \end{itemize} 
   \vspace{0.1cm}
   \hspace{0.1cm}\begin{center}\includegraphics[width=0.8\textwidth]{cofe-pmld.pdf}\end{center}
\end{frame}
