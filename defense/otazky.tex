    ...
    \begin{exampleblock}{Odpověď 1b)}
        \begin{columns}
            \begin{column}{0.5\textwidth}
                ...
                \end{itemize} 
                \includegraphics[width=\textwidth]{asy/kovek-4.pdf}
            \end{column}
            \begin{column}{0.5\textwidth}
                \begin{itemize}
                    \item Rozdílná propustnost
                ...
                \end{itemize} 
                \includegraphics[width=\textwidth]{asy/kovek-6.pdf}
            \end{column}
        \end{columns}
    \end{exampleblock}
\end{frame}
...
%            \item Oddělené zpracování má význam ve dvou případech
%                \begin{enumerate}
%                    \item Nemáme k dispozici model magnetické odezvy, zajímá nás pouze MO
%                        \begin{itemize}
%                            \item Určení MO je pouze slabě vázané na M (MO odezvu lze poměrně přesně určit položením $\bm{M}=\bm{H}_{\textrm{ext}}$, pokud magnetická anizotropie není příliš silná)
%                        \end{itemize}
%                    \item Nemáme k dispozici model MO odezvy (např. nízká symetrie materiálu, nekompenzovaná zrcadla mezi vzorkem a můstkem), zajímá nás pouze M
%                        \begin{itemize}
%                            \item Určení M je zcela nezávislé na MO (i experimentálně ověřeno), popsáno v práci (kap. 4.4)
%                        \end{itemize}
%                \end{enumerate}
%            \item Jinak oddělení nemá smysl
%        \end{itemize}
%    \end{exampleblock}
%\end{frame}
%
