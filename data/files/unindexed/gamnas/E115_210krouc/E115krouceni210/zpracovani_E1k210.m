...
for pol=0:11
	data=load(sprintf("E115_210_b%03d.dat",pol*15)); 									#krok 15 polarizace
	out=zeros(73,2);
...
save("out/E115_k210_V_vspol.dat", 'm', '-ascii')
save("out/E115_k210_M_vspol.dat", 'p', '-ascii')
save("out/E115_k210_V_vsmag.dat", 'M', '-ascii')
save("out/E115_k210_M_vsmag.dat", 'P', '-ascii')