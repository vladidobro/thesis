...
for pol=0:11
	data=load(sprintf("FR06krouceni50_PEM_beta%03d.dat",pol*15)); 									#krok 15 polarizace
	out=zeros(73,2);
...
save("out/FR06_k50_V_vspol.dat", 'm', '-ascii')
save("out/FR06_k50_M_vspol.dat", 'p', '-ascii')
save("out/FR06_k50_V_vsmag.dat", 'M', '-ascii')
save("out/FR06_k50_M_vsmag.dat", 'P', '-ascii')