...
Uvedený přístup není možné použít v případě, že osvětlované místo vzor\-ku není tvořené homogenním $\vec{M}$, ale je tvořené více doménami, ve kterých se $\vec{M}$ liší.
