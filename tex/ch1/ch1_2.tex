...
Nejdříve spomeneme větu z lineární algebry o polárním rozkladu matice\todocite{motlPestujemeLinearniAlgebru2002}: Každou komplexní matici $\mathcal{T}$ lze jednoznačně rozložit na součin unitární $\mathcal{U}$ a pozitivně semidefinitní hermitovské $\mathcal{H}_1, \mathcal{H}_2$ matice, $\mathcal{T}=\mathcal{U}\mathcal{H}_1 = \mathcal{H}_2 \mathcal{U}$.
...
Se zmenšujícím $\eta$ (vyšší kvalitou polarizátoru) výsledný elipsoid svým tvarem progresivně nabývá podobnosti doutníku, proto v této práci budeme akci $\mathbb{H}$ označovat jako \todo{napsat lepe a citace doutniky Fermi}\emph{doutníkovatění}
