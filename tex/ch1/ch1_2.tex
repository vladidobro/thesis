...
\begin{figure}[htbp]
    \centering
    \input{./img/tikz/polarizacni-elipsa.tikz}
...
Vzhledem k povaze prováděných experimentů se zřejmě jedná o daleko menší komplikaci, než které by přinesl přístup vhodný pro odraz s pevnou rovinou dopadu, kdy se odražená soustava podle ní zrcadlí.
...
\end{equation}
a tedy k vyjádření polarizačního stavu stačí třírozměrný \emph{redukovaný} Stokesův vektor $(s_1, s_2, s_3)^T$, který lze graficky zanést do třírozměrného prostoru.
...
\begin{figure}[htbp]
    \centering
    \includegraphics{./img/asy/pdf/poincareho-sfera.pdf}
...
Pro pozdější použití uvedeme totální diferenciál Stokesova vektoru (jakým způsobem se mění, při malé změně $\beta$, $\chi$, $I$)
\begin{equation}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{.4\textwidth}
        \centering
        \includegraphics{./img/asy/pdf/akce-muelleru-U.pdf}
    \end{subfigure}
    \begin{subfigure}{.55\textwidth}
        \centering
        \raisebox{0.5cm}{\includegraphics{./img/asy/pdf/akce-muelleru-H.pdf}}
    \end{subfigure}
