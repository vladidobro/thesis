...
\begin{figure}[htbp]
    ...
    \caption{Poincarého sféra. Je vyznačen rovník lineárních polarizací (rovina $S_z=0$, $\chi=0$) a póly kruhových polarizací $\chi=\pm 1$.}
...
Dále se zaměříme na to, jakým způsobem působí čisté Muellerovy matice, a jak jejich akci znázornit \emph{zobrazením Poincarého sféry}.
...
\begin{figure}[htbp]
    \centering
    \input{./img/asy/akce-muelleru.asy}
