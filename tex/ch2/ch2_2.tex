...
Metoda rotujícího pole\todocite{rotpole1}\todocite{rotpole2} rozšiřuje osmisměrnou metodu na Stoner-Wohlfarthův model: $\vHext$ je dostatečně silné na to, aby vzorek byl v jednodoménovém stavu a magnetizace byla saturovaná $|\M|=M_S$, ale nedostatečně na to, aby se neprojevila magnetická anizotropie $\phim\neq\phih$.
...
\begin{figure}[htbp]
    \centering
    \missingfigure{./img/rotpolevysledky.png}
...
Metoda rotujícího pole je velmi podobná metodě ROTMOKE z roku 1999\todocite{ROTMOKE}, která také v rotujícím in-plane vnějším poli separuje lineární a kvadratické jevy stejným způsobem.
