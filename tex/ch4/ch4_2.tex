...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{.35\textwidth}
        \centering
        \asypic{\input{./img/asy/kovek-2.asy}}
    \end{subfigure}%
    \begin{subfigure}{.34\textwidth}
        \centering
        \asypic{\input{./img/asy/kovek-3.asy}}
    \end{subfigure}%
...
\begin{figure}[htbp]
    \centering
    \asypic{\input{./img/asy/kovek-4.asy}}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}{.6\textwidth}
        \centering
        \asypic{\input{./img/asy/kovek-5.asy}}
    \end{subfigure}
    \begin{subfigure}{.3\textwidth}
        \centering
        \asypic{\input{./img/asy/zrcadla.asy}}
    \end{subfigure}
