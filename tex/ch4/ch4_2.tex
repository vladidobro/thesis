...
V odraženém svazku jsou sice zastoupeny obě polarizace, ale kvůli mírně odlišnému úhlu lomu se prostorově oddělí.\todo{vysvetlit?}
...
Druhou známkou nevyvážených ramen je nenulové  ${d'_0}^\textrm{A-B}$, které se projeví posunutím nulové kružnice jako na obr. \ref{fig:mustek-znazorneni-kovektoru}, která se po průchodu ideální destičkou pouze otočí v rovině $s_1s_2$.
...
Zde však už narážíme na závažný problém: v měřeném signálu, který by měl odpovídat pouze otočení polarizace, se nám projevují i změny elipticity neznámým faktorem $\sin\zeta_2$, který navíc závisí (i jeho znaménko) na $\beta$.
