...
Popsaná procedura byla běhěm úvodních měření provedena se vzorkem FR06 při teplotě \SI{420}{\kelvin} pro 10\todo{kontrola} vlnových délek v dostupném rozsahu.
...
\begin{figure}[htbp]
    \centering
    \missingfigure{ferh uvodni data}
...
\begin{figure}[htbp]
    \centering
    \missingfigure{cofe uvodni data}
...
Příčiny problémů byly odhaleny jako dvojí podstaty: ignorace vlivu zrcadel mezi vzorkem a optickým můstkem, a neúplné pochopení anizotropie MLD.\todopn{Je to ok, nebo je to urážlivé?}
