...
\end{equation}
Při orientaci polarizace $\beta=\gamma$ je amplituda změřené křivky $\Delta\beta(\phih)$ přímo $P_{\gamma+\SI{45}{\degree}}$, při polarizaci ve směru $\beta=\gamma+\SI{45}{\degree}$ je amplituda $P_{\gamma}$, viz obr. \ref{fig:urceni-MLD-ilustrace}.
Platí
\begin{align}
    \label{eqn:Pgamma}
