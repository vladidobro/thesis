...
V soustavě spojené se vzorkem používáme ještě jednu parametrizaci, která vyjadřuje sílu kvadratického jevu při magnetizaci ve význačných směrech [100] a [110] a lze je vizuálně přibližně odečítat z měřených dat.
Pokud $\gamma$ označuje úhel natočení krystalografického směru [100] studovaného vzorku\footnote{V našem případě tak nečiníme u vzorku FeRh.}, pak
\begin{equation}
    \Delta\beta = -P_{[100]} \cos 2 (\phim-\gamma) \sin 2(\beta-\gamma) + P_{[110]} \sin 2 (\phim-\gamma) \cos 2(\beta-\gamma) \,.
\end{equation}
Při orientaci polarizace ve směru [100] ($\beta=\gamma$, na obrázku \SI{0}{\degree}) je amplituda změřené křivky $\Delta\beta(\phih)$ přímo $P_{[110]}$, při polarizaci ve směru [110] ($\beta=\gamma+\SI{45}{\degree}$, na obrázku \SI{45}{\degree}) je amplituda $P_{[100]}$, viz obr. \ref{fig:urceni-MLD-ilustrace}.
Platí
\begin{equation}
...
\begin{figure}[htbp]
    ...
    \caption{Určení MLD koeficientů $P$. Měřená data s CoFe, pokojová teplota, \SI{1050}{\nano\meter}. Hodnoty $P$ lze odečítat přímo z grafu. Krystalografický směr CoFe [100] je rovnoběžný s $\phih = \SI{0}{\degree}$.}
