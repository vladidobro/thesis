Práce se zabývá magneto-optickým experimentem v Laboratoři OptoSpintroniky (LOS) KChFO MFF UK na adrese Ke Karlovu 3, Praha 2.\todopn{je to dobře napsané? měl bych zmínit FÚ?}
...
\begin{figure}[htbp]
    \centering
    \input{./img/tikz/schema-experimentu.tikz}
    \caption{schema}
